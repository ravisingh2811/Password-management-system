...
<nav class="nav_bar background h-nav-resp" style = "justify-content: flex-end;">
        ...
        <div class="logo"> 
          <p class="name"  style = "margin-top: 30px;" >MenosPass</p>
            ...
            <li><a class = "active"  href="home.php">Dasboard</a></li>
            <li><a  href="show_mess.php">Message</a></li>
    ...
    background: #585550;">
         <div class = "left"  style = " ">
           <h3 style = "color:white; padding:10px;">Current Admin : <?php echo $_SESSION['name'];     ?></h3>
           </div>
                 ...
                 <tbody>
                       <?php
                        ...
                        ?>
                            ...
                            <td><a class = "delete" href="delete.php?id=<?php echo $res['id'];?>" data-toggle="tooltip" data-placement="top" title="DELETE"> <i class = "fa fa-trash" aria-hidden = "true"></i>
                            </a></td>
